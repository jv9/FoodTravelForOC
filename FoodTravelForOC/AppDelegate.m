...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [AVOSCloud setApplicationId:@"ufL5MDVLceMWQVUlxIOBSgCD-gzGzoHsz" clientKey:@"eun41dPz9vJLx4fKP5MWhdqE"];
...
//    }];
    ...
    NSString *appVersion = [userDefault stringForKey:@"appVersion"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.angelorlover.Temp" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FoodTravelForOC" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FoodTravelForOC.sqlite"];
    NSError *error = nil;
